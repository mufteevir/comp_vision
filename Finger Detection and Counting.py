"""
Finger detection and Counting on video camera
"""
#imports
import cv2
import numpy as np
...
#The function calculates the weighted sum of the input
# image src and the accumulator dst so that dst becomes a running average of a frame sequence:

def calc_accum_avg(frame, accumulated_weight):
    '''
    Given a frame and a previous accumulated weight, computed the weighted average
...
#We just calculated the external contour of the hand.
# Now using that segmented hand, let's see how to calculate fingers.
# Then we can count how many are up!
